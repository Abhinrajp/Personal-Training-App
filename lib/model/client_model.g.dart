...
class ClientModelMAdapter extends TypeAdapter<ClientModelM> {
  ...
  ClientModelM read(BinaryReader reader) {
    ...
    return ClientModelM(
      ...
      weekimage: fields[13] as String?,
      weekoneimage: fields[12] as String?,
      pendingfee: fields[16] as String?,
    )..updates = fields[14] as String?;
  }

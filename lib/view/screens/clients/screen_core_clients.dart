...
class ScreenCoreClients extends StatefulWidget {
  final String tileclientdetails;
  const ScreenCoreClients({super.key, required this.tileclientdetails});

  @override
  State<ScreenCoreClients> createState() => _ScreenCoreClientsState();
}

class _ScreenCoreClientsState extends State<ScreenCoreClients> {
  @override
    ...
    return Scaffold(
      ...
      body: Center(
          child: ValueListenableBuilder(
              valueListenable: clientlistnotifierC,
